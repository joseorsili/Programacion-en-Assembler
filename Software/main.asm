...
BUCLE
    ...
    GOTO SWITCH_RC5_ON
    ; Si ninguno de los switches está a 1, usar la temperatura estándar (24 grados)
...
SWITCH_RC4_ON
    ...
    MOVLW 0x1B ; Cambio de temperatura en 27 grados
    ADDWF temperatura, F ; Sumar 27 grados
    GOTO BUCLE ; Continuar en el bucle principal

SWITCH_RC5_ON
    ; Código para cuando RC5 está activado
    MOVLW 0x0E ; Cambio de temperatura en 14 grados
    ADDWF temperatura, F ; Sumar 14 grados
    GOTO BUCLE ; Continuar en el bucle principal
